...
## 0. Note on trained models

Trained model binaries (`models/`, ~108 MB of AutoGluon `.pkl` files) are **not** included in this repository. They are fully regenerated by running the documented pipeline (`run_pipeline_geo.py`); see Section 2 below.
